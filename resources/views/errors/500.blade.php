...
<div class="flex items-center justify-center min-h-screen p-6">
    <div class="text-center max-w-md">
        ...
        <div class="mb-6">
            <span style="font-size:7rem;font-weight:800;color:#e2e8f0;line-height:1;display:block;">500</span>
            <div class="w-16 h-1 bg-teal-500 rounded-full mx-auto -mt-3"></div>
        </div>

        <h1 class="mb-2 text-2xl font-bold text-gray-900">Ceva nu a mers bine</h1>
        <p class="mb-8 text-sm text-gray-500 leading-relaxed">
            A apărut o eroare internă pe server. Te rugăm să încerci din nou sau să revii mai târziu.
        </p>
